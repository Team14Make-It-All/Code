...
<div class=left>
	...
	<tr> <td> <a href="mainPagePinfo.php" ><h1 class="center"> Problem info</h1></a> </td></tr>
	...
	<form id="details">
		...
		<h2>Company: <input name="f2" type="text" class="larger" id="f2"  size="30" ></h2>
		<h2>Caller: <input name="f3" type="text" class="larger" id="f3"  size="30" ></h2>
		<h2>Time of call: <input name="f4" type="text" class="larger" id="f4"  size="30" ></h2>
		<h2>Priority: <input name="f5" type="text" class="larger" id="f5"  size="30" ></h2>
	</form>
	</br>
	</div>
