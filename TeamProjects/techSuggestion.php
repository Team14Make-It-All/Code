...
Hardware - Jeff<input type='radio' name='rad1' id='spec1' class='bigger' checked='checked'/><br></br>
Hardware - Greg<input type='radio' name='rad1' id='spec2' class='bigger'/><br></br>
Software - Dan<input type='radio' name='rad1' id='spec3'  class='bigger'/><br></br>
</p>
</body>
