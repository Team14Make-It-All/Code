...
<body>
	<div id="grad1" style="text-align:center">
		...
		<h2>Username: <input name="username" type="text" class="larger" id="username"  size="12" /></h2>
		<h2>Password: <input name="password" type="text" class="larger" id="password"  size="12" /></h2>
		</form>
