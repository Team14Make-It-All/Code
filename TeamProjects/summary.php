...
<body>
<h1 class="center">Summary</h2>


<p>problem description: Paper stuck in printer</p>
<p>technician: Jeff</p>

<div class="bottom">
<div class="left-side">
<button type="button" id="b1" onclick="window.location.href='/TeamProjects/mainPage.php'"><h2>Amend</h2></button>
</div>
<div class="right-side">
<button type="button" id="b2"><h2>Commit</h2></button>
</div>
</div>
